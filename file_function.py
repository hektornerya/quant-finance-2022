# -*- coding: utf-8 -*-
"""
Created on Thu May  6 13:15:40 2021
...
def load_synchronised_timeseries(ric_x, ric_y):
    # a get timeseries of x and y
    table_x = file_function.load_timeseries(ric_x)
    table_y = file_function.load_timeseries(ric_y)
